...
/**
 * Classe principale de lancement d'une partie : 
 * (1) création du plateau, des joueurs et de l'interface,
 * (2) association des liens d'écoute de l'interface graphique par le controleur
 * @author courbis
 *
 */
