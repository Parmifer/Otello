...
/**
 * Controleur de l'application réceptionnant les événements de l'interface et activant les méthodes adéquates du modèle
 * @author courbis
 *
 */
...
public class ControleurOthello implements ActionListener {
	...
	/** 
	 * initialisation du controleur par des liens sur le modèle ( les joueurs et le plateau) et la vue (l'interface graphique)
	 * 
 ...
 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==ihm.getBoutonJoueurAuto() && plateau.aQuiLeTour().isAutomate())
