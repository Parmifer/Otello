...
/**
 * classe Plateau qui regroupe:
 * (1) le plateau du jeu (matrice de Couleurs)
 * (2) les liens vers les joueurs 
 * (3) la validation du coup demandé
 * (4) le retournement des pions
 * (5) la détection de la fin de partie (aucun des 2 joueurs ne peut jouer)
 * (6) le calcul du joueur actif 
 * @author courbis
 *
 */
public class Plateau extends Observable{
	...
	/**
	 * initialisation en début de partie du joueur actif (pions noirs)  et du joueur en attente (pions blancs)
	 * @param j1 joueur
	 * @param j2 joueur
	 */
  ...
  */
	 ...
	 * si plus de coups possibles, la fonction retourne null
	 * @return Joueur
	 */
