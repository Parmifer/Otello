...
public class Joueur {
	 ...
	 * @param niv niveau de performance du joueur (utile uniquement pour le joueur automatique)
	 */
	public Joueur(Couleur c, TypeJoueur t, Plateau p, int niv)
	// création d'un joueur de couleur donnée (NOIR ou BLANC) et de type donné (HUMAIN ou AUTOMATE)
